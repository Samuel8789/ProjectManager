...
function run_full_experiment(~, ~, use_psychtoolbox)
  % Callback for the "Run Full Experiment" button
  if use_psychtoolbox
    disp('Running full experiment with Psychtoolbox...');
    % Add your Psychtoolbox-specific code here
  else
    disp('Running full experiment without Psychtoolbox...');
    % Add your non-Psychtoolbox code here
  endif
endfunction
...
function create_gui()
  ...
  % Add a checkbox for Psychtoolbox
  psychtoolbox_checkbox = uicontrol(fig, 'Style', 'checkbox', 'String', 'Use Psychtoolbox', ...
                                    'Units', 'normalized', 'Position', [0.05, 0.1, 0.2, 0.05], ...
  ...
  run_experiment_btn = uicontrol(fig, 'Style', 'pushbutton', 'String', 'Run Full Experiment', ...
                                 ...
                                 'Callback', {@run_full_experiment, get(psychtoolbox_checkbox, 'Value')});
